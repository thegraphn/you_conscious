...
done_data_feeds_directory_path = os.path.join(root_folder, "data_processing")
done_data_feeds_directory_path = os.path.join(done_data_feeds_directory_path, "data_working_directory")
done_data_feeds_directory_path = os.path.join(done_data_feeds_directory_path, "done_datafeeds")
...
def write_2_file(list_articles, output_file, delimiter: str = "\t"):
    ...
    with open(output_file, "w", encoding="utf-8", newline="") as o:
        csv_writer = csv.writer(o, delimiter=delimiter,quotechar='"')
